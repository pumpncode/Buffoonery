-- Add "e_mult" and "e_chips" when Talisman isn't installed
-- Direct Code-Reference is: https://github.com/SpectralPack/Talisman/blob/main/talisman.lua
if not Buffoonery.compat.talisman then
