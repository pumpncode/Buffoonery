return {
        ...
        Joker = {
			...
			j_buf_afan = {
				...
				text = {"{C:mult}+#1#{} Множитель",
						...
						"{C:green}#2# из #3#{} шанс {C:attention}вернуться{}",
			...
			j_buf_kerman = {
				...
				text = {"Получает {C:mult}+#2#{} Множитель каждый раз,",
						...
						"{C:green}#4# из #3#{} шанс {C:attention}ВЗОРВАТЬСЯ{} при использовании",
			...
			j_buf_roulette = {
				...
				text = {"Когда выбран {C:attention}Блайнд{}, заработайте {C:money}$30{}",          
						"{C:green}#1# из #2#{} шанс, что вы {E:1,C:mult}проиграете игру{} вместо этого",
						"Если шанс достигает {C:green}1 из 2{} и вы выиграете,",
    ...
    misc = {
		dictionary = {
			...
			buf_Diamonds = "Бубны",
			-- Bunco compat --
			buf_Fleurons = "Флёроны",
			buf_Halberds = "Алебарды",
			-------- РАЗНОЕ --------
			k_buf_spc = "Особый",
